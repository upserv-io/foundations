...
export default class extends Controller {
  ...
  updateTooltipPosition() {
    ...
    // bottom right
    if (
      spaceBottom >= messageHeightInt - buttonHeightInt &&
      spaceRight >= widthSpacer + messageWidthInt
    ) {
      this.positionBottomRight(buttonRect, widthSpacer)
      ...
      this.messageTarget.style.top = buttonRect.top + 'px'

      // top-righ
    } else if (
      spaceTop >= messageHeightInt - buttonHeightInt &&
      spaceRight >= widthSpacer + messageWidthInt
    ) {
      this.messageTarget.style.left = buttonRect.right + widthSpacer + 'px'
      this.messageTarget.style.top =
        buttonRect.bottom - messageHeightInt + 'px'
  ...
  positionBottomRight(buttonRect, widthSpacer) {
    this.messageTarget.style.left = buttonRect.right + widthSpacer + 'px'
    this.messageTarget.style.top = buttonRect.top + 'px'
  }
}
