...
export default class extends Controller {
  ...
  updateTooltipPosition() {
    ...
    this.messageTargetCone = this.copyElementWithDescendants(
      this.messageTarget
    )
    // bottom right
    if (
      ...
      this.messageTargetCone.style.left =
        buttonRect.left - widthSpacer - messageWidthInt + 'px'
      this.messageTargetCone.style.top =
      ...
      this.messageTargetCone.style.left = buttonRect.right + widthSpacer + 'px'
      this.messageTargetCone.style.top =
    ...
    document.body.appendChild(this.messageTargetCone)
  }
