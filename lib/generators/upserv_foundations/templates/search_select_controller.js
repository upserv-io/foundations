...
export default class extends Controller {
  connect() {
    ...
    this.searchElm.addEventListener('blur', () => {
      ...
      // trigger the input event because there is an event listener that
      // updates the search results on the input event. This is important
      // because when we set the searchElm value to null, it doesn't reset
      // the results list unless we also trigger the input event
      const inputEvent = new Event('input', { bubbles: true })
      this.searchElm.dispatchEvent(inputEvent)
      // update css classes
